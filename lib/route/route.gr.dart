...
class AccountSettingsRoute extends _i10.PageRouteInfo<void> {
  const AccountSettingsRoute({List<_i10.PageRouteInfo>? children})
      : super(
...
class PersonOfChatRoute extends _i10.PageRouteInfo<void> {
  const PersonOfChatRoute({List<_i10.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i9.TrainingPage]
class TrainingRoute extends _i10.PageRouteInfo<void> {
  const TrainingRoute({List<_i10.PageRouteInfo>? children})
      : super(
          TrainingRoute.name,
          initialChildren: children,
        );
